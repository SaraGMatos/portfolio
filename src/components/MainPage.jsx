            ...
            >
              ...
              >
                ...
                <p className="text-teagreen text-justify">
                  Planning and designing smart interfaces using visual tools
                  like <b>Figma</b> and <b>Excalidraw</b>.
                </p>
                <p className="text-teagreen text-justify">
                  Creating user-friendly interfaces with web technologies such
                  as
                ...
                <p className="text-teagreen text-justify">
                  Adding some colours and sparkles using popular frameworks like{" "}
              ...
              >
                ...
                <p className="text-teagreen text-justify">
                  Creating, seeding and querying <b>PostgreSQL</b> databases
                  using both <b>psql</b> and <b>Azure Data Studio</b>.
                </p>
                <p className="text-teagreen text-justify">
                  Using <b>Supabase</b> as backend service to quickly build
                  robust apps.
                </p>
                <p className="text-teagreen text-justify">
